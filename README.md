...
- **Hugging Face Inference API** - AI-powered food image classification
...
The platform uses **Hugging Face AI** (`nateraw/food` model) for:

1. **Food Classification** - Identifies food type from images (101 categories)
2. **Edibility Assessment** - Determines if food is safe, questionable, or spoiled
3. **Spoilage Indicators** - Lists common signs of spoilage for detected food type
4. **Shelf Life Estimation** - Predicts how long food can be stored
5. **Reuse Suggestions** - Provides creative ways to repurpose leftovers
6. **Recipe Ideas** - Suggests recipes using the leftover food
7. **Storage Tips** - Offers best practices for food preservation
...
See [HUGGINGFACE_SETUP.md](./HUGGINGFACE_SETUP.md) for setup instructions.
...
- nateraw for the food classification model
